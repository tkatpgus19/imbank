...
import com.imb.km_system.analysis.dto.HourlyConsultationDto;
...
public class AnalysisController {
    ...
    public ApiResponseDto<?> selectChart5(@PathVariable(name = "dept-id") Long deptId,
                                          @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
                                          @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {

        List<HourlyConsultationDto> data = analysisService.getAverageHourlyConsultations(deptId, startDate, endDate);
